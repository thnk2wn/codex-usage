...
- `show_usage_card` renders a compact native card in the conversation. Its collapsed row shows context pressure, cumulative session tokens, and the aggregate Codex limit; expanding it reveals the latest turn, cached input, subagents, reset time, alerts, and top tasks.
